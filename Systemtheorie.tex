...
\begin{multicols*}{4}
    ...
    Autonome Zustandsgleichung (Erregung konst.) \begin{equation*}
        \vec x(t)=\underbrace{-\ma A^{-1}\ma B\vec v_0}_{x_\infty}+\exp(\ma A(t-t_0))(x_0+\underbrace{\ma A^{-1}\ma B\vec v_0}_{-x_\infty})
    \end{equation*}
    ...
    komplexe Eigenwerte: $c_1 \e^{\alpha t}(\cos{(\beta t)}\mathbf{q}{\text{reell}} - \sin{(\beta t)}\mathbf{q}{\text{imag}}) + c_2\e^{\alpha t}(\sin{(\beta t)}\mathbf{q}{\text{reell}} - \cos{(\beta t)}\mathbf{q}{\text{imag}})$\\
