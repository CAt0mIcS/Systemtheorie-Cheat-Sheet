...
\begin{multicols*}{4}
    ...
    \textbf{Knotenpunkt}\\
    $\lambda_{1,2} \in \mathbb R < 0, |\lambda_1| < |\lambda_2|$: Trajektorien von Richtung (Eigenvektor) des schnelleren Eigenwerts ($\mathbf{q}_2, \xi_2$) schmiegen sich an an Richtung des langsameren Eigenwerts ($\mathbf{q}_1, \xi_1$). Stabil für $\lambda_1,\lambda_2 < 0$, instabil sonst.\\
    ...
    \textbf{Phasenportrait bei konstanter Erregung}\\
    Zentrum des Phasenportraits (z.B. Sattelpunkt) wird im $x_\infty$ verschoben \\
