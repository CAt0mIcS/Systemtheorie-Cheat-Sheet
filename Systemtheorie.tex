...
\begin{multicols*}{4}
    ...
    \sectionbox{
        ...
        \begin{tabular}{ll}
            ...
            \includegraphics[scale = 0.2]{./img/konkave_resistor.png} & \includegraphics[scale = 0.2]{./img/konvex_resistor.png} \\
        \end{tabular}
    }
    ...
    Falls Eigenvektoren komplex: $\mathbf{q}_r = \Re{q_1}$\qquad$\mathbf{q}_i = \Im{q_1}$ mit $\lambda_1$ der EW mit positivem Imaginärteil\\
    ...
    \textbf{Strudelpunkt}\\
    $\lambda_{1} = \lambda_2^* = \alpha + \beta j$, $\alpha \neq 0$: Je nach $\sgn(\alpha)$ stabiler (-) oder instabiler (+) Strudel in Drehrichtung von $\mathbf{q}r$ ($\xi{\text{reel}1}$) nach $-\mathbf{q}i$ ($\xi{\text{reel}2}$) \\
